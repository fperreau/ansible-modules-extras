...
# Copyright (C) 2015  Frederic PERREAU <fperreau@fr.ibm.com>
...
class SoftLayerInventory(object):
    ...
    def process_instance(self, instance, instance_type="virtual"):
        ...
        self.inventory["_meta"]["hostvars"][dest]['ansible_ssh_host'] = instance['primaryBackendIpAddress']
        self.inventory["_meta"]["hostvars"][dest]['ansible_ssh_port'] = 22
        self.inventory["_meta"]["hostvars"][dest]['ansible_ssh_user'] = 'root'
        ...
        # Inventory: group by primaryBackendIpAddress
        self.push(self.inventory, self.to_safe(instance['primaryBackendIpAddress']), dest)

        # Inventory: group by primaryIpAddress
        if 'primaryIpAddress' in instance.keys():
            self.push(self.inventory, self.to_safe(instance['primaryIpAddress']), dest)
